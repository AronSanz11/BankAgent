...
public class BankOntology extends Ontology implements BankVocabulary {
   ...
   private BankOntology() {
      ...
      try {
         ...
         //Transference
         add(as = new AgentActionSchema(TRANSFERS), Transfer.class);
         as.add(TRANSFERS_TYPE, (PrimitiveSchema) getSchema(BasicOntology.INTEGER), ObjectSchema.MANDATORY);
         as.add(TRANSFERS_ORIGIN_ACCOUNT, (PrimitiveSchema) getSchema(BasicOntology.STRING), ObjectSchema.MANDATORY);
            as.add(TRANSFERS_TARGET_ACCOUNT, (PrimitiveSchema) getSchema(BasicOntology.STRING), ObjectSchema.MANDATORY);
         as.add(TRANSFERS_AMOUNT, (PrimitiveSchema) getSchema(BasicOntology.FLOAT), ObjectSchema.MANDATORY);
      }
