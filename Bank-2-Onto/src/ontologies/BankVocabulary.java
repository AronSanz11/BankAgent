...
public interface BankVocabulary {
   ...
   public static final int TRANSFERENCE = 6;
   ...
   public final float TRANS_CHARGE = (float)3.5;
   ...
   public static final String TRANSFERS_TYPE = "type";
   public static final String TRANSFERS_ORIGIN_ACCOUNT = "origin_account";
   public static final String TRANSFERS_TARGET_ACCOUNT = "target_account";
   public static final String TRANSFERS_AMOUNT = "amount";
