...
//                         to create a new account
   ...
   void transfer(){
       ...
       String accName2 = chooseAccountTarget();   
       
       Account acc1 = null;
      if ((acc1 = findAccountByName(accName)) == null) {
